...
# [GEONAMES]
###############################################################################
GEONAMES_ADDRESS_FULL_WEIGHT = 1.3
GEONAMES_ADDRESS_MULTI_COMPONENT_WEIGHT = 1.15
GEONAMES_ADDRESS_SINGLE_COMPONENT_WEIGHT = 1.05
GEONAMES_FUZZY_WEIGHT_FACTOR = 0.95
GEONAMES_QUERY_CITY_WEIGHT = 1.0
GEONAMES_QUERY_ADDRESS_MULTI_WEIGHT = 0.85
GEONAMES_QUERY_ADDRESS_SINGLE_WEIGHT = 0.9
GEONAMES_QUERY_COUNTRY_WEIGHT = 0.65
