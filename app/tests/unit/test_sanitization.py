...
def test_country_canonical_names_and_aliases_normalize_through_reference_mapping() -> None:
    catalog = load_reference_catalog()
    alias_map = {entry.alias.strip().casefold(): entry.iso2 for entry in catalog.country_aliases}
