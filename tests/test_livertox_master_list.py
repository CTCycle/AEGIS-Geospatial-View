...
from AEGIS.app.utils.serializer import DataSerializer, LIVERTOX_COLUMNS
...
def test_serializer_roundtrip_uses_unified_table() -> None:
    ...
    with patch(
        "AEGIS.app.utils.serializer.database.save_into_database"
    ) as save_mock:
    ...
    with patch(
        "AEGIS.app.utils.serializer.database.load_from_database",
        return_value=frame,
    ):
