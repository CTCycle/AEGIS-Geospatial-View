...
def test_openai_provider_uses_responses_api(monkeypatch) -> None:
    ...
    monkeypatch.setattr("AEGIS.server.services.llm.openai_provider.OpenAI", _FakeOpenAIClient)
...
def test_google_provider_uses_genai_sdk(monkeypatch) -> None:
    ...
    monkeypatch.setattr("AEGIS.server.services.llm.google_provider.genai.Client", _FakeGoogleClient)
    monkeypatch.setattr(
        "AEGIS.server.services.llm.google_provider.genai_types.HttpOptions",
        _FakeHttpOptions,
    )
