    ...
    mapped = map_structured_intent_to_location_request(
        {
            ...
            "overlays": {"requested": ["openaq_air_quality"]},
            "base_map": "osm_default",
            "planning": {"datetime_inference": "2026-01-01T00:00:00Z"},
        }
    )
    ...
    mapped = map_structured_intent_to_location_request(
        {
            ...
            "display_area": {"mode": "bbox", "bbox": [13.0, 52.3, 13.8, 52.7]},
            "overlays": {"requested": ["eea_noise_2019"]},
            "planning": {"datetime_inference": "2026-01-01T00:00:00Z"},
        }
    )
