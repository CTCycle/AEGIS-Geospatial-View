...
Last updated: 2026-09-24 (`CONTROLLED-FAULT` PASS; T2-01/02 remain PARTIAL after a blocked exact-lane recheck; `a1b4e43f` passed all four hosted-CI jobs)
...
| Tier 2 | Core agent workflows | 7 | `PARTIAL` | The [2026-09-24 recheck](../../QA/tier2-validation-develop-20260924/report.md) could not start the exact-provider browser flows; `T2-01`/`T2-02` remain `PARTIAL`, `T2-03` remains `PASS`, and `T2-04`–`T2-07` remain `UNRUN`. |
...
| Slice | Scope | Status | Verification date | Tested source boundary | Evidence | Next action |
| --- | --- | --- | --- | --- | --- | --- |
| `T2-01` | Plain and ambiguous locations; Springfield clarification; invalid-coordinate retention; Italian-context Milan request | `PARTIAL` | 2026-09-24 (live recheck blocked) | `develop@a53040ae137d3e5c7c4cd1ddf8a09274e56aeb1d` | [2026-09-24 recheck report](../../QA/tier2-validation-develop-20260924/report.md), [scenario status](../../QA/tier2-validation-develop-20260924/slice.json), [2026-09-23 execution report](../../QA/tier2-validation-develop-20260923-retry/report.md), [prior browser evidence](../../QA/tier2-validation-develop-20260923-retry/browser-evidence.md) | The isolated Settings screen had no selected model or OpenCode Go key, so the exact-lane flow did not start. Keep the `Mostrami Milano` clarification visible and improve/revalidate the Texas alternative and `Rodano` label; prior Zurich bounds rejection and Springfield clarification/render passed. |
| `T2-02` | Hydrated Rome to ambiguous Florence, then explicit Florence, Tuscany, Italy replacement | `PARTIAL` | 2026-09-24 (live recheck blocked) | `develop@a53040ae137d3e5c7c4cd1ddf8a09274e56aeb1d` | [2026-09-24 recheck report](../../QA/tier2-validation-develop-20260924/report.md), [scenario status](../../QA/tier2-validation-develop-20260924/slice.json), [2026-09-23 execution report](../../QA/tier2-validation-develop-20260923-retry/report.md), [prior browser evidence](../../QA/tier2-validation-develop-20260923-retry/browser-evidence.md) | No exact-lane request was made in the recheck. Prior hydration and explicit Florence render passed; clarify before replacing Rome when the location remains ambiguous, then rerun the full transition. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ROUTE-UNIT — semantic catalog and alias contracts | Routing / catalog | Local focused native pytest | PASS | 2026-09-24 | `develop@a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` | [86 focused backend tests](../../QA/tier2-validation-develop-20260924/focused-backend.log), [recheck report](../../QA/tier2-validation-develop-20260924/report.md) | Current capability routing, location resolution, and agent-loop regressions pass; preserve semantic subject matching, required aliases, generic-infrastructure clarification, and source-availability gates. |
| ROUTE-LIVE — exact-lane route matrix | Routing / catalog | Chrome UI, exact `opencode-go / deepseek-v4.1-flash` | PARTIAL | 2026-09-24 (related recheck blocked) | `develop@a53040ae137d3e5c7c4cd1ddf8a09274e56aeb1d` | [2026-09-24 recheck](../../QA/tier2-validation-develop-20260924/report.md), [2026-09-23 T2 execution](../../QA/tier2-validation-develop-20260923-retry/report.md), [prior browser evidence](../../QA/tier2-validation-develop-20260923-retry/browser-evidence.md), [historical route observations](../../QA/native-agent-loop-evaluation-20260917-final/manual-live-observations.md) | T2-03 Rome/Colosseum POI routing remains passing. The current exact-lane recheck did not execute because the isolated runtime lacked its selected model and key. The broader matrix remains partial for Acropolis semantics, imagery extent, weather budget, USGS/land-cover aliases, generic-infrastructure clarification, and Milan candidate quality. |
...
| CONTROLLED-HAPPY — visible MapLibre completion | Browser / MapLibre | Local Angular + backend, WebSocket fixture after real browser ack | PASS | 2026-09-24 | `develop@a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` | [current completion screenshot](../../QA/tier2-validation-develop-20260924/controlled-fault/screenshots/__test_controlled_map_completion_requires_and_records_visible_rendering[chromium]/controlled-map-completed.png), [full module](../../QA/tier2-validation-develop-20260924/controlled-fault/full-module.log) | Preserve real `map.render_ack` gating and visible completion; this is controlled evidence only. |
| CONTROLLED-FAULT — recovery and acknowledgement matrix | Browser / MapLibre | Local Angular app; WebSocket fixture injects only the controlled fault, MapLibre emits browser acknowledgements | PASS | 2026-09-24 | `develop@a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` | [full module: 10 passed](../../QA/tier2-validation-develop-20260924/controlled-fault/full-module.log), [scenario reports](../../QA/tier2-validation-develop-20260924/controlled-fault/reports/), [recheck report](../../QA/tier2-validation-develop-20260924/report.md) | The complete controlled suite passes, including supersession, stale acknowledgement, and retry exhaustion. This does not establish live public-raster loading or the complete provider/browser matrix. |
...
| MATRIX-22 — complete required scenario matrix | Coverage | Exact live provider plus controlled browser | PARTIAL | 2026-09-24 | `develop@a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` | [2026-09-24 recheck report](../../QA/tier2-validation-develop-20260924/report.md), [controlled module: 10 passed](../../QA/tier2-validation-develop-20260924/controlled-fault/full-module.log), [original matrix report](../../QA/native-agent-loop-evaluation-20260917-final/final-report.md) | The controlled acknowledgement submatrix now passes. The exact-lane T2 recheck was blocked before execution; broad route, coverage, multilingual, composition, and remaining Tier 2–5 rows still prevent an overall PASS claim. |
| HOSTED-CI — exact tested head | Hosted CI | GitHub Actions push workflow on `develop` | PASS | 2026-09-24 | `develop@a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` | [exact-head GitHub Actions run 35970154295](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35970154295), [2026-09-24 recheck report](../../QA/tier2-validation-develop-20260924/report.md) | All four jobs passed: `frontend-build-and-tests`, `persistence-conformance`, `backend-unit-tests`, and `capability-contract-validation`. Remaining T2 limitations are recorded separately.
| PROCESS-CLEANUP — task-owned services and browser | Test harness | Local host, ports 4512/7059/9876 | PASS | 2026-09-24 | `develop@a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` | [2026-09-24 recheck report](../../QA/tier2-validation-develop-20260924/report.md), [isolated launcher log](../../QA/tier2-validation-develop-20260924/official-launcher.log) | Exact task-owned backend/frontend processes were stopped, task-created browser tabs were closed, ports were free, and `.env` was restored byte-for-byte. One protected pytest scratch directory remains and is recorded in the report. |
