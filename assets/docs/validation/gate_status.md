...
Last updated: 2026-09-26 (`T3-01`/`T3-02`/`T3-03` PASS; `T3-04` BLOCKED after the current exact-lane browser run; `T0-04` remains PARTIAL only for the safe historical timing comparator; source tested at `develop@5947bdd` plus scoped changes; pushed head `9b34c5aa` passed hosted CI run `36241506428`)
