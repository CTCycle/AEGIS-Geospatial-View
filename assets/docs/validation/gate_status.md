...
Last updated: 2026-09-24 (`CONTROLLED-FAULT` PASS; T2-01/02 remain PARTIAL after a blocked exact-lane recheck; hosted CI for this change pending)
...
| MATRIX-22 — complete required scenario matrix | Coverage | Exact live provider plus controlled browser | PARTIAL | 2026-09-24 | `develop@a53040ae137d3e5c7c4cd1ddf8a09274e56aeb1d` plus the controlled test-harness revision documented in the report | [2026-09-24 recheck report](../../QA/tier2-validation-develop-20260924/report.md), [controlled module: 10 passed](../../QA/tier2-validation-develop-20260924/controlled-fault/full-module.log), [original matrix report](../../QA/native-agent-loop-evaluation-20260917-final/final-report.md) | The controlled acknowledgement submatrix now passes. The exact-lane T2 recheck was blocked before execution; broad route, coverage, multilingual, composition, and remaining Tier 2–5 rows still prevent an overall PASS claim. |
