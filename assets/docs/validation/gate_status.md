...
Last updated: 2026-09-25 (`T2-04` PASS after the approved isolated six-call inventory run; `T0-04` remains PARTIAL only for the safe historical timing comparator; source tested at `develop@800e0568`; evidence head `db5b9485` passed exact-head hosted CI run `36152093449`)
