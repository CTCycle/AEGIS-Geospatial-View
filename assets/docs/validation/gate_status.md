...
Last updated: 2026-09-25 (`T2-05`/`T2-06`/`T2-07` PASS on selected exact-lane scenarios; `T2-04` and `T0-04` remain PARTIAL; exact-head CI runs 36114905386 and 36115432750 exposed strict typing and generated OpenAPI snapshot issues, now fixed locally; CI for the regenerated snapshot is pending)
...
| OPENAPI-SCHEMA - generated shared API contract | Backend / frontend contract | Runtime schema export and exact equality test | PASS | 2026-09-25 | `develop@a424f1f2` plus regenerated shared schema | [2026-09-25 report](../../QA/tier2-validation-develop-20260925-next-slices/report.md), [full local backend suite](../../QA/tier2-validation-develop-20260925-next-slices/report.md) | Regenerated `app/shared/openapi.json` with the repository script; runtime equality passed as part of 420 local backend tests. Exact-head hosted verification is recorded separately. |
...
| HOSTED-CI - exact implementation head | Hosted CI | GitHub Actions push workflow on `develop` | UNRUN | 2026-09-25 | Corrected code plus regenerated shared schema not yet pushed | [failed run 36114905386](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/36114905386), [failed run 36115432750](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/36115432750), [2026-09-25 report](../../QA/tier2-validation-develop-20260925-next-slices/report.md) | Earlier exact-head run `36051868085` passed on its cited historical commit. The first current attempt found three strict typing errors; the second found the missing generated `evidence_inspection` enum. Both are fixed locally; push and verify CI on the combined correction before claiming a current hosted pass. |
