...
| LIVE-BROWSER-SMOKE — realtime UI smoke | Browser / realtime | Local services 4512/7059, exact provider lane, isolated runtime data | PASS | 2026-09-17 | `558f1966` | [live-browser-558f-final.log](../../QA/native-agent-loop-evaluation-20260917-final/live-browser-558f-final.log) | Four smoke tests passed; do not promote this subset to complete 22-scenario proof. |
...
| PROCESS-CLEANUP — task-owned services and browser | Test harness | Local host, ports 4512/7059/9876 | UNRUN | 2026-09-17 | `558f1966` | [final-report.md](../../QA/native-agent-loop-evaluation-20260917-final/final-report.md) | Stop and verify only task-owned AEGIS services after documentation is committed; preserve unrelated services and caches. |
