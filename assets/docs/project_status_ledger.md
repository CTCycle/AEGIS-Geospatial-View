...
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | Validation commit `a1b4e43ff20ab8683f34c04e9ff78e59dc01f74f` passed all four jobs on [GitHub Actions run 35970154295](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35970154295). | The run validates the pushed source/test commit; live-browser status remains separately classified. | — | 2026-09-24 | hosted CI | [gate status](validation/gate_status.md), [2026-09-24 recheck report](../QA/tier2-validation-develop-20260924/report.md), [T1-10 hosted-CI record](../QA/tier1-validation-develop-20260923/T1-10/hosted-ci.md) | Rerun hosted CI on future source or test changes. |
