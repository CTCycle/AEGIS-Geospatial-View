...
| `validation.application-foundations-tier1` | `PARTIAL` | Tier 1 route, state, conversation, realtime, run, API, jobs, Settings, credential, model, and context foundations. | T1-07 passed mounted job lifecycle/API coverage, the exact-lane live background job, cooperative shutdown, and real app-restart `404` checks. Tested source boundary: `develop@3fd0c820c2d4de0fb06120b6feac80b199d57f26`. The roll-up is 10 `PASS` / 2 `PARTIAL` within Tier 1 and 15 `PASS` / 2 `PARTIAL` / 51 `UNRUN` across the campaign; evidence boundaries remain slice-specific. | T1-09 Settings navigation/drafts; T1-10 credential failure fixtures. | — | 2026-09-23 | integration/E2E | [validation strategy](validation/strategy.md), [Tier 1 checklist](validation/tier1_application_foundations.md), [2026-09-23 T1-07 report](../QA/tier1-validation-develop-20260923/T1-07/report.md), [T1-06 report](../QA/tier1-validation-develop-20260923/T1-06/report.md), [T1-03 report](../QA/tier1-validation-develop-20260923/T1-03/report.md), [2026-09-22 T1-02 report](../QA/tier1-validation-develop-20260922/T1-02/report.md), [historical Tier 1 baseline](../QA/tier1-application-foundations-20260921/ledger.md) | Continue with T1-09; keep downstream and hosted-CI claims separate. |
...
| `validation.environment-startup-tier0` | `VALIDATED` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | All five Tier 0 slices remain passing; the latest campaign reconciliation records 15 `PASS`, 2 `PARTIAL`, and 51 `UNRUN` after T1-07. | Remaining downstream live/browser/provider validation is separate and incomplete; exact-head hosted CI is separately validated. | — | 2026-09-23 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [T1-07 report](../QA/tier1-validation-develop-20260923/T1-07/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md) | Continue at T1-09; retain downstream partial and unrun boundaries. |
...
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | T1-07 implementation commit `3fd0c820c2d4de0fb06120b6feac80b199d57f26` passed all four jobs on [GitHub Actions run 35861096479](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35861096479). | The earlier `fccafa1f` run failed on the stale test path; the corrected T1-06 head also passed, followed by this exact-head T1-07 result. | — | 2026-09-23 | hosted CI | [gate status](validation/gate_status.md), [T1-07 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-07/hosted-ci.md), [T1-06 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-06/hosted-ci.md), [previous failure record](../QA/tier1-validation-develop-20260923/T1-03/hosted-ci.md), [testing and quality](coding/testing_and_quality.md) | Rerun hosted CI on each future pushed change. |
