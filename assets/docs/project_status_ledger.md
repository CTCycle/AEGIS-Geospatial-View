...
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | Validation commit `53260863c2f0fa9b1ffc5b64e9edc687236eb91d` passed all four jobs on [GitHub Actions run 35901790479](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35901790479). | Each subsequent push needs its own exact-head result; live-browser status remains separately classified. | — | 2026-09-23 | hosted CI | [gate status](validation/gate_status.md), [T2 report](../QA/tier2-validation-develop-20260923/report.md), [T1-10 hosted-CI record](../QA/tier1-validation-develop-20260923/T1-10/hosted-ci.md) | Rerun hosted CI on each future pushed change.
