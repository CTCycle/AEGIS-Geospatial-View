...
| `agent.capability-routing.live-language` | `PARTIAL` | Natural-language routing and capability discovery for keyless geospatial requests. | The 2026-09-23 exact-lane T2 retry fixed POI map routes missing `DATA_RETRIEVAL`; Colosseum and central-Rome flows now discover, execute, render, and acknowledge Overpass results. | `ISSUE-006` and remaining T2 gaps: Acropolis semantics, imagery extent, weather budget, USGS/land-cover aliases, generic-infrastructure clarification, and Milan candidate quality remain open. Overpass itself reports partial reliability/limited extent. | — | 2026-09-23 | E2E | [agentic search](geospatial/agentic_search.md), [T2 retry report](../QA/tier2-validation-develop-20260923-retry/report.md), [browser evidence](../QA/tier2-validation-develop-20260923-retry/browser-evidence.md) | Complete the remaining exact-lane route matrix; preserve source, route, coverage, and render evidence for each row. |
...
| `testing.complete-live-matrix` | `PARTIAL` | Complete live provider, browser, raster, composition, and coverage scenario matrix. | The 2026-09-20 focused matrix remains `PARTIAL`; the current T2 retry adds exact-lane location, hydration, POI/render-ack, and API conflict evidence without closing the full matrix. | Explicit gaps remain for raster loading, route aliases and semantics, provider availability, coverage reruns, and other catalog families. | External providers and configured sources vary by environment. | 2026-09-23 | E2E | [gate ledger](validation/gate_status.md), [current T2 retry](../QA/tier2-validation-develop-20260923-retry/report.md), [focused report](../QA/aegis-geospatial-e2e-validation-20260920/report.md), [hazard rerun](../QA/aegis-hazard-hydrology-e2e-20260920/report.md) | Execute the remaining rows and retain exact provider/model, browser, source/layer, and acknowledgement evidence. |
