...
The follow-up 2026-09-24 continuation used the user-configured exact `opencode-go / deepseek-v4.1-flash` lane. `T2-01` and `T2-02` pass with visible clarification and acknowledged maps; `T2-04` is partial at the configured model-call limit; `T0-04` remains partial after fresh and warm launcher checks. See the [continuation report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md) and [browser evidence](../QA/tier2-validation-develop-20260924-head77c5d67/browser-evidence.md).
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `runtime.startup.windows-local` | `PARTIAL` | Windows launcher port-consent guard, warm dependency/build reuse, concurrent backend/frontend startup, and isolated no-op database startup. | The official launcher recheck preserves inherited non-empty `AEGIS_DATA_DIR` on fresh and warm starts; both services reached health in the isolated runtime. See the [2026-09-24 continuation report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md). | No paired same-machine pre-change timing; provider outage, protected-process/ownership-change races, injected service-failure cleanup, and full startup scenarios remain unverified. Angular `ng serve` still compiles at launch. | — | 2026-09-24 | E2E + automated | [startup](runtime/startup.md), [runtime modes](runtime/modes.md), [optimization report](../QA/startup-optimization-20260922/report.md), [current continuation](../QA/tier2-validation-develop-20260924-head77c5d67/report.md) | Capture paired before/after warm timings and exercise provider-outage and failed-start cleanup paths. |
...
| `backend.agent.native-loop` | `VALIDATED` | Native route, typed tool exposure, observation/recovery cycle, bounded context, and terminal completion contracts. | The 2026-09-25 regression passed 115 focused tests and the full 420-test backend CI selection locally; strict Pyright reports 0 errors/warnings/informations. The selected exact lane completed coordinate, direct forecast, saved-evidence inspection, and map-handoff scenarios. Exact-head CI run `36114905386` found three strict typing errors; run `36115432750` then found the generated OpenAPI snapshot missing `evidence_inspection`. Both issues are corrected locally and final exact-head CI is pending. | Live provider and full-browser scenario coverage remain separate; one live AQ run recovered from a model-generated semantic argument rejection. | - | 2026-09-25 | integration/E2E | [2026-09-25 report](../QA/tier2-validation-develop-20260925-next-slices/report.md), [browser evidence](../QA/tier2-validation-develop-20260925-next-slices/browser-evidence.md), [native harness](geospatial/native_harness_bootstrap.md), [gate ledger](validation/gate_status.md), [2026-09-24 focused report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md) | Confirm exact-head hosted CI for the regenerated shared schema before claiming a hosted pass. |
...
| `model.opencode-go.deepseek-v4.1-flash` | `VALIDATED` | Exact configured provider/model lane readiness and visible selection without silent fallback. | The 2026-09-24 post-restart Settings probe returned `Verified` and `Native tool probe passed`; the live browser used the exact lane without fallback. See the [current browser evidence](../QA/tier2-validation-develop-20260924-head77c5d67/browser-evidence.md). The 2026-09-19/20 browser reports also observed the exact lane. | Readiness does not prove every geospatial scenario or provider parity. | — | 2026-09-24 | E2E | [configuration](runtime/configuration.md), [gate ledger](validation/gate_status.md), [current browser evidence](../QA/tier2-validation-develop-20260924-head77c5d67/browser-evidence.md) | Preserve the exact lane in future revalidation and record any provider change explicitly. |
...
| `agent.capability-routing.live-language` | `PARTIAL` | Natural-language routing and capability discovery for keyless geospatial requests. | The 2026-09-25 focused five-file regression passes 115 tests. Exact-lane browser slices now pass text-only Colosseum coordinates, 24-hour Open-Meteo weather/AQ, pharmacy-filtered Overpass text results, saved-history hydration, and saved-evidence inspection; see the [2026-09-25 report](../QA/tier2-validation-develop-20260925-next-slices/report.md). Capability inventory remains partial at 36 candidates and `max_model_calls=4`. | `ISSUE-006` and remaining gaps: Acropolis semantics, imagery extent, weather budget, USGS/land-cover aliases, generic-infrastructure clarification, and incomplete inventory discovery. One AQ live run recovered from a model-generated argument validation rejection; Overpass reports partial reliability and bounded coverage. | — | 2026-09-25 | E2E + automated | [2026-09-25 report](../QA/tier2-validation-develop-20260925-next-slices/report.md), [browser evidence](../QA/tier2-validation-develop-20260925-next-slices/browser-evidence.md), [2026-09-24 continuation](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [focused backend log](../QA/tier2-validation-develop-20260924-head77c5d67/focused-backend-final.log) | Continue the inventory under the existing model-call guard and complete the remaining route matrix with exact source, coverage, and render evidence. |
| `agent.capability-discovery.inventory` | `PARTIAL` | Bounded runtime catalog pagination, result semantics, and discovery-only completion without map rendering. | The exact-lane browser run completed three pages of 12 candidates (36 total) without a map, then reached the configured `max_model_calls=4` limit before the bounded 50-candidate inventory completed. | Full inventory completion is not established; continuation beyond the configured model-call guard was not used. | — | 2026-09-24 | E2E + automated | [continuation report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [browser evidence](../QA/tier2-validation-develop-20260924-head77c5d67/browser-evidence.md), [focused tests](../QA/tier2-validation-develop-20260924-head77c5d67/focused-backend-final.log) | After approval of a budget adjustment or guard-respecting continuation policy, resume from the catalog cursor and verify complete inventory state. |
...
| `validation.application-foundations-tier1` | `VALIDATED` | Tier 1 route, state, conversation, realtime, run, API, jobs, Settings, credential, model, and context foundations. | T1-10 passed on `develop@8e32f82e3f094e5fb17c3978fad69b9f80b7af0b`; Tier 1 remains 12 `PASS`. Current campaign roll-up is 22 `PASS` / 2 `PARTIAL` / 0 `BLOCKED` / 44 `UNRUN`. The historical implementation and generated API contract at `develop@7685cce7e23c5d4cb9edd603a8b49d3ef5aaa8d9` passed all four jobs in [hosted CI run 36051868085](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/36051868085); the 2026-09-25 continuation has not yet run hosted CI. | `T0-04` and `T2-04` remain partial; broader downstream live/browser/provider coverage remains open. | - | 2026-09-24 | integration/E2E | [validation strategy](validation/strategy.md), [2026-09-25 continuation](../QA/tier2-validation-develop-20260925-next-slices/report.md), [2026-09-24 continuation](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [Tier 1 checklist](validation/tier1_application_foundations.md), [T1-10 report](../QA/tier1-validation-develop-20260923/T1-10/report.md) | Complete remaining partial and unrun slices while keeping browser, provider, and exact-head CI boundaries distinct. |
...
| `validation.environment-startup-tier0` | `PARTIAL` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | The historical Tier 0 report passed its tested boundary. Current-head evidence confirms fresh/warm Windows launcher data-root isolation, but the full `T0-04` startup component remains partial. The campaign is 22 `PASS`, 2 `PARTIAL`, 0 `BLOCKED`, and 44 `UNRUN`. | Paired timing, provider-outage behavior, process ownership races, and injected startup-failure cleanup remain open; downstream validation also remains partial or unrun. | — | 2026-09-24 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md), [current T2 report](../QA/tier2-validation-develop-20260925-next-slices/report.md) | Complete remaining T0-04 startup cases and preserve other partial, blocked, and unrun boundaries. |
| `testing.complete-live-matrix` | `PARTIAL` | Complete live provider, browser, raster, composition, and coverage scenario matrix. | The controlled acknowledgement module passes 10/10; exact-lane browser evidence now additionally passes direct coordinates, 24-hour weather/AQ, ten pharmacy-filtered POIs, saved-history hydration, and evidence inspection. The current focused five-file suite passes 115 tests. Capability discovery remains at 36/50 candidates under `max_model_calls=4`. | Explicit gaps remain for public raster loading, route aliases and semantics, provider parity, discovery completion, and other catalog families. One live AQ run recovered from a semantic argument validation rejection; general Overpass reliability remains partial. | External providers and configured sources vary by environment; `T2-04` continuation is limited by `max_model_calls=4`. | 2026-09-25 | E2E + automated | [2026-09-25 continuation report](../QA/tier2-validation-develop-20260925-next-slices/report.md), [browser evidence](../QA/tier2-validation-develop-20260925-next-slices/browser-evidence.md), [previous T2 continuation report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [controlled module](../QA/tier2-validation-develop-20260924-head66008da/controlled-fault/full-module.log) | Continue the remaining rows with the exact provider/model and browser-authoritative evidence. |
| `ci.hosted-exact-head` | `PARTIAL` | Hosted CI result for an exact pushed branch head. | Prior exact-head source commits passed all four jobs. Current attempts found strict typing errors in `36114905386` and a stale generated OpenAPI enum in `36115432750`; both are fixed in the current working tree and local static analysis plus all 420 backend unit tests pass. | Exact-head CI for the corrected source and regenerated schema is not yet complete; the previous failures remain historical evidence, not a current pass. | — | 2026-09-25 | hosted CI + local | [gate status](validation/gate_status.md), [2026-09-25 report](../QA/tier2-validation-develop-20260925-next-slices/report.md), [prior exact-head recheck report](../QA/tier2-validation-develop-20260924-head66008da/report.md) | Push the regenerated shared schema and verify the resulting exact-head workflow. |
...
| --- | --- | --- | --- | --- |
| `runtime.startup.windows-local` | `PARTIAL` | Paired warm timing, provider outage, changed-owner races, and injected startup-failure cleanup. | `HIGH` | Continue T0-04 with the official launcher and isolated data/cache roots; keep shared runtime state protected. |
...
| `agent.capability-discovery.inventory` | `PARTIAL` | Three pages and 36 of up to 50 candidates returned before the configured four-model-call limit. | `HIGH` | Resume from the cursor only after approval of a budget adjustment or guard-respecting continuation policy; verify completion without rendering a map. |
