...
| `backend.agent.native-loop` | `VALIDATED` | Native route, typed tool exposure, observation/recovery cycle, bounded context, and terminal completion contracts. | The 2026-09-25 five-file regression passed 115 focused tests, strict Pyright now reports 0 errors/warnings/informations, and the selected exact lane completed coordinate, direct forecast, saved-evidence inspection, and map-handoff scenarios. The complete hosted backend suite passed historically on `develop@7685cce7`; first exact-head CI run `36114905386` exposed three strict typing errors, now corrected and awaiting follow-up CI. | Live provider and full-browser scenario coverage remain separate; one live AQ run recovered from a model-generated semantic argument rejection. | - | 2026-09-25 | integration/E2E | [2026-09-25 report](../QA/tier2-validation-develop-20260925-next-slices/report.md), [browser evidence](../QA/tier2-validation-develop-20260925-next-slices/browser-evidence.md), [native harness](geospatial/native_harness_bootstrap.md), [gate ledger](validation/gate_status.md), [2026-09-24 focused report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md) | Re-run the focused native suite after agent-loop, route, policy, or tool changes; confirm exact-head hosted CI for this correction before claiming a pass. |
...
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | Validation commit `0113812c7e4e1945c9a2846bec1942c6889a7264` passed all four jobs on [GitHub Actions run 36003422893](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/36003422893). | The run validates the pushed tested source; live-browser status remains separately classified. | — | 2026-09-24 | hosted CI | [gate status](validation/gate_status.md), [exact-head recheck report](../QA/tier2-validation-develop-20260924-head66008da/report.md), [T1-10 hosted-CI record](../QA/tier1-validation-develop-20260923/T1-10/hosted-ci.md) | Rerun hosted CI on future source or test changes. |
