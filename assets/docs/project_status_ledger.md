...
| `backend.agent.native-loop` | `VALIDATED` | Native route, typed tool exposure, observation/recovery cycle, bounded context, and terminal completion contracts. | Current native gates for routing, state, finalization, and render admission remain passing; the focused route/catalog/location suite passes 155 tests and the complete hosted backend suite passes on `develop@7685cce7`. | Live provider and full-browser scenario coverage remain separate gates. | - | 2026-09-24 | integration/E2E | [native harness](geospatial/native_harness_bootstrap.md), [gate ledger](validation/gate_status.md), [current focused report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [focused backend log](../QA/tier2-validation-develop-20260924-head77c5d67/focused-backend-final.log) | Re-run the focused native suite after agent-loop, route, policy, or tool changes. |
...
| `agent.capability-routing.live-language` | `PARTIAL` | Natural-language routing and capability discovery for keyless geospatial requests. | The 2026-09-24 focused suite passed 155 tests; exact-lane browser evidence passes Milan clarification/render and Rome-to-Florence clarification/render. Capability inventory is partial after 36 candidates and `max_model_calls=4`. | `ISSUE-006` and remaining gaps: Acropolis semantics, imagery extent, weather budget, USGS/land-cover aliases, generic-infrastructure clarification, and incomplete inventory discovery. Overpass reports partial reliability/limited extent. | — | 2026-09-24 | E2E + automated | [continuation report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [browser evidence](../QA/tier2-validation-develop-20260924-head77c5d67/browser-evidence.md), [focused backend log](../QA/tier2-validation-develop-20260924-head77c5d67/focused-backend-final.log) | Continue the inventory under an approved guard-respecting model-call policy and complete the remaining route matrix with exact source, coverage, and render evidence. |
...
| `validation.application-foundations-tier1` | `VALIDATED` | Tier 1 route, state, conversation, realtime, run, API, jobs, Settings, credential, model, and context foundations. | T1-10 passed on `develop@8e32f82e3f094e5fb17c3978fad69b9f80b7af0b`; Tier 1 remains 12 `PASS`. Current campaign roll-up is 19 `PASS` / 2 `PARTIAL` / 0 `BLOCKED` / 47 `UNRUN`. The current implementation and generated API contract at `develop@7685cce7e23c5d4cb9edd603a8b49d3ef5aaa8d9` passed all four jobs in [hosted CI run 36051868085](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/36051868085). | `T0-04` and `T2-04` remain partial; broader downstream live/browser/provider coverage remains open. | - | 2026-09-24 | integration/E2E | [validation strategy](validation/strategy.md), [current continuation](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [Tier 1 checklist](validation/tier1_application_foundations.md), [T1-10 report](../QA/tier1-validation-develop-20260923/T1-10/report.md) | Complete the partial and unrun slices while keeping browser, provider, and exact-head CI boundaries distinct. |
...
| `validation.environment-startup-tier0` | `PARTIAL` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | The historical Tier 0 report passed its tested boundary. Current-head evidence confirms fresh/warm Windows launcher data-root isolation, but the full `T0-04` startup component remains partial. The campaign is 19 `PASS`, 2 `PARTIAL`, 0 `BLOCKED`, and 47 `UNRUN`. | Paired timing, provider-outage behavior, process ownership races, and injected startup-failure cleanup remain open; downstream validation also remains partial or unrun. | — | 2026-09-24 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md), [current T2 report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md) | Complete remaining T0-04 startup cases and preserve other partial, blocked, and unrun boundaries. |
| `testing.complete-live-matrix` | `PARTIAL` | Complete live provider, browser, raster, composition, and coverage scenario matrix. | The controlled acknowledgement module passes 10/10; the current exact-lane continuation passes Milan and Florence location flows plus the Zurich coverage guardrail, with 155 focused tests passing. Capability discovery stops at 36/50 candidates at the configured model-call limit. | Explicit gaps remain for public raster loading, route aliases and semantics, provider parity, discovery completion, and other catalog families. | External providers and configured sources vary by environment; `T2-04` continuation is limited by `max_model_calls=4`. | 2026-09-24 | E2E | [current continuation report](../QA/tier2-validation-develop-20260924-head77c5d67/report.md), [browser evidence](../QA/tier2-validation-develop-20260924-head77c5d67/browser-evidence.md), [controlled module](../QA/tier2-validation-develop-20260924-head66008da/controlled-fault/full-module.log), [2026-09-23 T2 retry](../QA/tier2-validation-develop-20260923-retry/report.md) | Continue the remaining rows with the exact provider/model and browser-authoritative evidence. |
