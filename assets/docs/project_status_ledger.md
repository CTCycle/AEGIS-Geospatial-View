...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `runtime.startup.windows-local` | `PARTIAL` | Windows launcher port-consent guard, warm dependency/build reuse, concurrent backend/frontend startup, and isolated no-op database startup. | The 2026-09-24 official launcher reached backend and frontend health with the isolated runtime; details in the [T2 recheck report](../QA/tier2-validation-develop-20260924/report.md) and [launcher log](../QA/tier2-validation-develop-20260924/official-launcher.log). Prior checks include 401 backend, 248 Angular, and 19 frontend-state tests; see the [startup optimization report](../QA/startup-optimization-20260922/report.md). | No paired same-machine pre-change timing; dynamic-provider outage, protected-process/ownership-change races, and injected service-failure cleanup remain unverified. Angular `ng serve` still compiles at launch. | — | 2026-09-24 | E2E + automated | [startup](runtime/startup.md), [runtime modes](runtime/modes.md), [optimization report](../QA/startup-optimization-20260922/report.md), [T2 recheck report](../QA/tier2-validation-develop-20260924/report.md) | Capture paired before/after warm timings and exercise provider-outage and failed-start cleanup paths. |
...
| `agent.capability-routing.live-language` | `PARTIAL` | Natural-language routing and capability discovery for keyless geospatial requests. | The 2026-09-23 exact-lane T2 retry fixed POI map routes missing `DATA_RETRIEVAL`; the 2026-09-24 focused backend suite adds 86 passing routing, location-resolution, and agent-loop tests. The related exact-lane browser recheck was blocked before request execution because the isolated runtime had no selected model or OpenCode Go key. | `ISSUE-006` and remaining T2 gaps: Acropolis semantics, imagery extent, weather budget, USGS/land-cover aliases, generic-infrastructure clarification, and Milan candidate quality remain open. Overpass itself reports partial reliability/limited extent. | — | 2026-09-24 | E2E + automated | [2026-09-24 recheck report](../QA/tier2-validation-develop-20260924/report.md), [focused backend log](../QA/tier2-validation-develop-20260924/focused-backend.log), [2026-09-23 T2 execution](../QA/tier2-validation-develop-20260923-retry/report.md) | Re-run the exact-lane location and route flows when the isolated runtime has the configured provider; complete the remaining route matrix and preserve source, route, coverage, and render evidence. |
...
| `agent.map-render-ack-recovery` | `PARTIAL` | Candidate map preparation, browser acknowledgement, failed-render recovery, supersession, and last-known-good preservation. | The 2026-09-24 visible MapLibre module passes its happy path and all eight controlled fault cases; live FEMA/ESA source loading still fails. | `ISSUE-002`: public raster source failures remain. | Public source-load behavior and last-known-good behavior with those public overlays prevent a complete claim. | 2026-09-24 | E2E | [2026-09-24 controlled module](../QA/tier2-validation-develop-20260924/controlled-fault/full-module.log), [recheck report](../QA/tier2-validation-develop-20260924/report.md), [gate ledger](validation/gate_status.md), [hazard rerun](../QA/aegis-hazard-hydrology-e2e-20260920/report.md) | Investigate FEMA/ESA source loading and validate composition/retention with browser-visible public overlays; keep the controlled acknowledgement module passing. |
...
| `validation.environment-startup-tier0` | `VALIDATED` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | All five Tier 0 slices remain passing; the campaign is now 18 `PASS`, 2 `PARTIAL`, 0 `BLOCKED`, and 48 `UNRUN`. The official launcher reached backend/frontend health with the isolated test root during the T2 retry. | T2-01/02 are `PARTIAL`, T2-03 is `PASS`, and other downstream live/browser/provider validation remains open. | — | 2026-09-23 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [T1-10 report](../QA/tier1-validation-develop-20260923/T1-10/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md), [T2 retry report](../QA/tier2-validation-develop-20260923-retry/report.md) | Complete the location partials and unrun T2 slices; retain all other partial, blocked, and unrun boundaries. |
| `testing.complete-live-matrix` | `PARTIAL` | Complete live provider, browser, raster, composition, and coverage scenario matrix. | The 2026-09-24 controlled acknowledgement module passes 10/10, while the related exact-lane T2 recheck was blocked before any provider request. The 2026-09-23 T2 execution and API conflict evidence remain the latest live workflow evidence. | Explicit gaps remain for raster loading, route aliases and semantics, provider availability, coverage reruns, and other catalog families. | External providers and configured sources vary by environment; the isolated exact lane was not configured for this recheck. | 2026-09-24 | E2E | [2026-09-24 recheck report](../QA/tier2-validation-develop-20260924/report.md), [controlled module](../QA/tier2-validation-develop-20260924/controlled-fault/full-module.log), [2026-09-23 T2 retry](../QA/tier2-validation-develop-20260923-retry/report.md), [focused report](../QA/aegis-geospatial-e2e-validation-20260920/report.md), [hazard rerun](../QA/aegis-hazard-hydrology-e2e-20260920/report.md) | Execute the remaining rows with the exact provider/model and browser-authoritative evidence. |
