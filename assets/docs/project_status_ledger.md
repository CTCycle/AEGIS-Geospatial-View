...
| `validation.environment-startup-tier0` | `VALIDATED` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | All five Tier 0 slices remain passing; the latest campaign reconciliation records 17 `PASS`, 0 `PARTIAL`, and 51 `UNRUN` after T1-10. | Remaining downstream live/browser/provider validation is separate and incomplete; exact-head hosted CI is separately validated. | — | 2026-09-23 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [T1-10 report](../QA/tier1-validation-develop-20260923/T1-10/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md) | Continue at T2-01; retain downstream partial, blocked, and unrun boundaries. |
