...
| `ui.settings-provider-access` | `PARTIAL` | Settings sections for model selection, model-provider credentials, local runtime, geospatial access, and persisted application runtime configuration. | T1-09 passes seven-section URL navigation and rendering, invalid-tab fallback, browser history, draft retention, controlled save, and return/reopen using safe fixtures; 31 focused Settings Karma tests, 2 targeted browser regressions, the toolbar regression, and the Angular production build pass. See the [T1-09 report](../QA/tier1-validation-develop-20260923/T1-09/report.md). | Controlled unreadable-credential/API-failure states remain for T1-10. An exploratory broader Settings run also recorded a model-selection response mismatch outside T1-09; retain it for its own validation boundary. | — | 2026-09-23 | integration/E2E | [frontend architecture](architecture/frontend_architecture.md), [access overview](geospatial/providers/access_overview.md), [user settings](user/settings_and_access.md), [runtime validation](../QA/settings-runtime-validation-20260921.md), [T1-09 report](../QA/tier1-validation-develop-20260923/T1-09/report.md) | Continue with controlled T1-10 credential failure fixtures. |
| `validation.application-foundations-tier1` | `PARTIAL` | Tier 1 route, state, conversation, realtime, run, API, jobs, Settings, credential, model, and context foundations. | T1-09 passed on `develop@c090abd1ca9d6d78e82e798da9167b9d19b3fc23`; exact-head CI run 35873578752 passed all four jobs. The roll-up is 11 `PASS` / 1 `PARTIAL` within Tier 1 and 16 `PASS` / 1 `PARTIAL` / 51 `UNRUN` across the campaign; evidence boundaries remain slice-specific. | T1-10 credential failure fixtures remain partial; broader downstream live/browser/provider coverage remains open. | — | 2026-09-23 | integration/E2E | [validation strategy](validation/strategy.md), [Tier 1 checklist](validation/tier1_application_foundations.md), [T1-09 report](../QA/tier1-validation-develop-20260923/T1-09/report.md), [T1-09 hosted CI](../QA/tier1-validation-develop-20260923/T1-09/hosted-ci.md), [2026-09-23 T1-07 report](../QA/tier1-validation-develop-20260923/T1-07/report.md), [T1-06 report](../QA/tier1-validation-develop-20260923/T1-06/report.md), [T1-03 report](../QA/tier1-validation-develop-20260923/T1-03/report.md), [2026-09-22 T1-02 report](../QA/tier1-validation-develop-20260922/T1-02/report.md), [historical Tier 1 baseline](../QA/tier1-application-foundations-20260921/ledger.md) | Continue with T1-10; keep downstream and hosted-CI claims separate. |
...
| `validation.environment-startup-tier0` | `VALIDATED` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | All five Tier 0 slices remain passing; the latest campaign reconciliation records 16 `PASS`, 1 `PARTIAL`, and 51 `UNRUN` after T1-09. | Remaining downstream live/browser/provider validation is separate and incomplete; exact-head hosted CI is separately validated. | — | 2026-09-23 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [T1-09 report](../QA/tier1-validation-develop-20260923/T1-09/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md) | Continue at T1-10; retain downstream partial and unrun boundaries. |
...
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | T1-09 implementation commit `c090abd1ca9d6d78e82e798da9167b9d19b3fc23` passed all four jobs on [GitHub Actions run 35873578752](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35873578752). | The earlier T1-06 and T1-07 exact-head runs also passed; each future pushed change needs its own result. | — | 2026-09-23 | hosted CI | [gate status](validation/gate_status.md), [T1-09 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-09/hosted-ci.md), [T1-07 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-07/hosted-ci.md), [T1-06 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-06/hosted-ci.md), [testing and quality](coding/testing_and_quality.md) | Rerun hosted CI on each future pushed change. |
