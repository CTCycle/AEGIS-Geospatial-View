...
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | Current validation commit `3734df22a09eb83c279ac28467654c4cfa29bab6` passed all four jobs on [GitHub Actions run 35915263134](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35915263134). | Each subsequent push needs its own exact-head result; live-browser status remains separately classified. | — | 2026-09-23 | hosted CI | [gate status](validation/gate_status.md), [T2 retry report](../QA/tier2-validation-develop-20260923-retry/report.md), [T1-10 hosted-CI record](../QA/tier1-validation-develop-20260923/T1-10/hosted-ci.md) | Rerun hosted CI on each future pushed change.
