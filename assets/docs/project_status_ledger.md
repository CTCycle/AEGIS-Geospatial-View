...
| `validation.environment-startup-tier0` | `VALIDATED` | Tier 0 environment, current SQLite/Alembic schema, legacy Settings migration, Windows startup, and API composition slices. | All five Tier 0 slices remain passing; the latest campaign reconciliation records 17 `PASS`, 0 `PARTIAL`, 2 `BLOCKED`, and 49 `UNRUN` after the T2 attempt. | T2-01/T2-02 live validation is blocked before browser startup; other downstream live/browser/provider validation remains separate and incomplete. | — | 2026-09-23 | integration | [Tier 0 final report](../QA/tier0-validation-develop-20260922/final/report.md), [T1-10 report](../QA/tier1-validation-develop-20260923/T1-10/report.md), [validation strategy](validation/strategy.md), [gate ledger](validation/gate_status.md), [current T2 report](../QA/tier2-validation-develop-20260923/report.md) | Retry T2-01/T2-02 after official launcher backend health is restored; retain all other partial, blocked, and unrun boundaries. |
| `testing.complete-live-matrix` | `PARTIAL` | Complete live provider, browser, raster, composition, and coverage scenario matrix. | 2026-09-20 focused matrix remains `PARTIAL`; the 2026-09-23 T2 attempt was blocked before browser startup and added no complete-matrix rows. | Explicit gaps remain for raster loading, routing, provider availability, coverage reruns, and other catalog families. | External providers and configured sources vary by environment. | 2026-09-23 | E2E | [gate ledger](validation/gate_status.md), [current T2 attempt](../QA/tier2-validation-develop-20260923/report.md), [focused report](../QA/aegis-geospatial-e2e-validation-20260920/report.md), [hazard rerun](../QA/aegis-hazard-hydrology-e2e-20260920/report.md) | Execute the missing rows and retain the exact provider/model, browser, source/layer, and acknowledgement evidence. |
| `ci.hosted-exact-head` | `VALIDATED` | Hosted CI result for an exact pushed branch head. | T1-10 implementation commit `8e32f82e3f094e5fb17c3978fad69b9f80b7af0b` passed all four jobs on [GitHub Actions run 35891289442](https://github.com/CTCycle/AEGIS-Geospatial-View/actions/runs/35891289442). | Each future pushed change needs its own exact-head result. | — | 2026-09-23 | hosted CI | [gate status](validation/gate_status.md), [T1-10 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-10/hosted-ci.md), [T1-09 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-09/hosted-ci.md), [T1-07 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-07/hosted-ci.md), [T1-06 hosted-CI result](../QA/tier1-validation-develop-20260923/T1-06/hosted-ci.md), [testing and quality](coding/testing_and_quality.md) | Rerun hosted CI on each future pushed change. |
